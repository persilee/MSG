...
class Database{
    ...
    private function open($size){
        if($this->fp){
            ...
            $this->_filename   = "{$backuppath}{$this->file['name']}-{$this->file['part']}.sql";
            if($this->config['compress']){
                $this->_filename = "{$this->_filename}.gz";
                $this->fp = @gzopen($this->_filename, "a{$this->config['level']}");
            } else {
                $this->fp = @fopen($this->_filename, 'a');
            }
            $this->size = filesize($this->_filename) + $size;
        }
    }
